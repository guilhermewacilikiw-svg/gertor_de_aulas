-- Script to create a SECURITY DEFINER function to bypass RLS and create users safely
...
BEGIN
  ...
  INSERT INTO public.students (school_id, user_id, name, email, status, xp_points, level)
  VALUES (p_school_id, v_new_user_id, p_name, p_email, 'active', 0, 1)
