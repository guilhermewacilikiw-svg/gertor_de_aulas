...
export default async function LandingPage() {
  ...
  return (
    <div className="bg-[#0a0a0f] min-h-screen selection:bg-[#A27AE8]/30 overflow-hidden relative font-sans">
      ...
      <section className="max-w-6xl mx-auto px-4 mb-32 relative z-10">
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row bg-black/50 border border-white/5 cyber-clip overflow-hidden group hover:border-[#A27AE8]/30 transition-colors">
            ...
            <div className="md:w-1/2 bg-[#13131A] relative border-l border-white/5 min-h-[300px] flex items-center justify-center p-8">
               <div className="absolute inset-0 cyber-grid opacity-30"></div>
               <div className="relative bg-[#0a0a0f] border border-[#A27AE8]/30 p-6 cyber-clip w-full shadow-[0_0_30px_rgba(162,122,232,0.1)]">
          ...
          <div className="flex flex-col md:flex-row-reverse bg-black/50 border border-white/5 cyber-clip-reverse overflow-hidden group hover:border-[#C0E87A]/30 transition-colors">
            <div className="p-10 md:w-1/2 flex flex-col justify-center">
            ...
            <div className="md:w-1/2 bg-[#13131A] relative border-r border-white/5 min-h-[300px] flex items-center justify-center p-8">
               <div className="absolute inset-0 cyber-grid opacity-30"></div>
          ...
          <div className="flex flex-col md:flex-row bg-black/50 border border-white/5 cyber-clip overflow-hidden group hover:border-[#A27AE8]/30 transition-colors">
            ...
            <div className="md:w-1/2 bg-[#13131A] relative border-l border-white/5 min-h-[300px] flex items-center justify-center p-8">
               <div className="absolute inset-0 cyber-grid opacity-30"></div>
               <div className="relative bg-[#0a0a0f] border border-[#A27AE8]/30 cyber-clip w-full h-40 flex items-center justify-center group-hover:shadow-[0_0_30px_rgba(162,122,232,0.2)] transition-shadow cursor-pointer">
      ...
      <section id="metodologia" className="max-w-6xl mx-auto px-4 mb-32 relative z-10">
        <div className="text-center mb-20 space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-sm uppercase tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="relative group cursor-pointer">
              <div className={`bg-black/90 p-8 border-t-2 ${item.border} transition-all duration-300 h-full relative z-10 hover:-translate-y-2 hover:bg-[#13131A] shadow-[0_10px_30px_rgba(0,0,0,0.5)] group-hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]`}>
                
                {/* Tech Step Marker */}
                <div className="absolute top-0 right-0 p-2 border-b border-l border-white/10 bg-white/5 text-[10px] font-black tracking-widest text-gray-500">
                  PASSO {item.step}
                </div>

                <div className={`w-12 h-12 border ${item.border} bg-white/5 flex items-center justify-center mb-8 rotate-45 group-hover:rotate-90 transition-transform duration-500 shadow-[0_0_15px_rgba(255,255,255,0.05)]`}>
                ...
                <div className="absolute bottom-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
              </div>
            </div>
          ))}
        </div>
