          ...
          <div className="relative w-full max-w-md max-h-[90vh] overflow-y-auto bg-[#0a0a0f] border border-white/10 rounded-3xl p-6 shadow-2xl text-white">
            ...
            <div className="flex gap-2 mt-4 relative z-10">
              <button 
                ...
                className={`flex-1 py-2 text-xs font-bold rounded-lg transition-colors ${mode === 'invoice' ? 'bg-white text-black' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}
              >
                Gerar Fatura
              </button>
              <button 
                onClick={() => { setMode('contract'); setError(null); }}
                className={`flex-1 py-2 text-xs font-bold rounded-lg transition-colors ${mode === 'contract' ? 'bg-white text-black' : 'bg-white/5 text-gray-400 hover:bg-white/10'}`}
              >
                Configurar Contrato
              </button>
            </div>
              ...
              <form onSubmit={handleContractSubmit} className="pt-4 space-y-4 relative z-10">
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <select name="student_id" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all appearance-none">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="plan_name" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600" placeholder="Ex: Mensalidade Violão Iniciante" />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="number" step="0.01" min="0" name="amount" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600" placeholder="Ex: 150.00" />
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  <div className="space-y-1 flex-1">
                    ...
                    <input type="number" min="1" max="31" name="due_day" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 px-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600" placeholder="Ex: 10" />
                  </div>
                  <div className="space-y-1 flex-1">
                    <label className="text-xs font-bold uppercase tracking-wider text-gray-400 ml-1">Forma</label>
                    <select name="payment_method" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 px-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all appearance-none">
                ...
                <div className="pt-4 flex gap-3">
                  <button type="submit" disabled={loading} className="w-full py-3.5 rounded-xl bg-white text-black font-black text-sm hover:brightness-110 shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-all flex items-center justify-center gap-2">
              ...
              <form onSubmit={handleInvoiceSubmit} className="pt-4 space-y-4 relative z-10">
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="date" name="due_date" required className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all" />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input type="url" name="boleto_url" className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600" placeholder="https://banco.com.br/boleto..." />
                  </div>
                </div>
          ...
          <div className="relative w-full max-w-sm max-h-[90vh] overflow-y-auto bg-[#0a0a0f] border border-white/10 rounded-3xl p-6 shadow-2xl text-white">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <select name="status" defaultValue={invoice.status} className="w-full bg-black/40 border border-white/10 rounded-xl py-3 px-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all appearance-none">
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <LinkIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500" />
                  <input type="url" name="boleto_url" defaultValue={invoice.boleto_url || ''} className="w-full bg-black/40 border border-white/10 rounded-xl py-3 pl-10 pr-4 text-white text-sm focus:outline-none focus:border-white focus:ring-1 focus:ring-white transition-all placeholder-gray-600" placeholder="https://..." />
                </div>
              </div>

              <div className="pt-4 flex gap-3">
                <button type="submit" disabled={loading} className="w-full py-3 rounded-xl bg-white text-black font-black text-sm hover:brightness-110 shadow-[0_0_20px_rgba(255,255,255,0.4)] transition-all flex items-center justify-center gap-2">
