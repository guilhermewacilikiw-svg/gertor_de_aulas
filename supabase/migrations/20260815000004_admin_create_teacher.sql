-- Função para criar um professor ignorando o fluxo normal de signUp (usado por Administradores)
...
BEGIN
    ...
    VALUES (p_school_id, v_public_user_id, 'TEACHER');

    -- 6. Inserir no perfil específico de Professor
    INSERT INTO public.teachers (user_id, school_id, specialty)
    VALUES (v_public_user_id, p_school_id, p_specialty);
